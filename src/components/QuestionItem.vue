...
<template>
    <div class="border-2 border-emerald-400 flex flex-col items-center justify-end min-w-fit max-w-max rounded px-5 shadow-lg shadow-emerald-900 gap-4 relative">
